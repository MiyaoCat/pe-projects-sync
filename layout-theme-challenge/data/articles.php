...
$articles = [
	...
	[
		...
		"thumbnail" => "../images/brown-bag.png",
		"price" => 450,
		"sizes" => ["S", "M", "L", "XL"],
		"colors" => ["blue", "dodgerblue", "lightblue"]
	],
	[
		"heading" => "So Soft Scarf",
		"description" => "Here's a really expensive t-shirt. The price, not the cotton will make you feel rich.",
		"thumbnail" => "../images/scarf.png",
		"price" => 999,
		"sizes" => ["one size"],
		"colors" => ["red", "pink", "salmon", "wheat", "brown", "orangered", "orange", "blue", "dodgerblue", "lightblue", "black", "white"]
	],
	[
		"heading" => "Hi Priced T",
		"description" => "Here's a really expensive t-shirt. The price, not the cotton will make you feel rich.",
		...
		"price" => 220,
		"sizes" => ["S", "M", "L", "XL"],
		"colors" => ["pink", "salmon", "blue", "lightblue", "dodgerblue", "black", "white"]
	],
	[
		"heading" => "Hi Value",
		"description" => "Here's a little info to help you understand if this is a thing you want to know about.",
