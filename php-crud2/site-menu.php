...
<nav class="site-menu">
	...
	<a class="<?php if ($page =='list' AND $sport !='basketball' AND $sport !='football' AND $college != 'University of Washington') 
		{ echo 'active'; }?>" 
		href="?page=list">All Athletes</a>

	<a class="<?php if ($sport=='basketball') 
		{ echo 'active';}?>" 
		href="?page=list&sport=basketball">Basketball</a>

	<a class="<?php if ($sport == 'football') 
		{ echo 'active'; }?>" 
		href="?page=list&sport=football">Football</a>

	<a class="<?php if ($college =='University of Washington') 
		{ echo 'active'; }?>" 
		href="?page=list&college=University of Washington">Huskies</a>

	<a class="<?php if ($page =='create') 
		{ echo 'active'; }?>" 
